...
class Timer:
    ...
    def deadline(self) -> Optional[float]:
        ...
        return self._started_at + self._timeout
...
class ConnectionPool(Generic[EndpointT, ConnectionT], BaseConnectionPool[threading.Event, EndpointT, ConnectionT]):
    ...
    def close(self, graceful_timeout: Optional[float] = None, timeout: Optional[float] = None) -> None:
        ...
        self._close_connections(graceful_timeout, timeout=timeout)
    ...
    def _dispose_connection(self, conn_info: ConnectionInfo[EndpointT, ConnectionT], timeout: Optional[float]) -> None:
        try:
